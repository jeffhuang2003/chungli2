...
(function($) {
    ...
    var methods = {
        ...
        /**
         * Check the maximum size (in characters)  For TTWO
         * <pre>
         * �ק�쥻��������Ҥ覡
         * ���嬰2�Ӧr���A���M�N�O1�Ӧr��
         * </pre>
        ...
        _maxSize: function(field, rules, i, options) {
        	var max = rules[i + 1];
        	var text = field.val().match(/[^\x00-\xff]/ig);
        	var len;
        	if (text == null)
        	{
        	...
        	{
        		len=field.val().length + text.length;
        	}
            if (len > max) {
        ...
        /**
         * �ˬd���r��(�Hbyte�ӭp��A����r��2��byte�A��L��1��byte)
         * 
         * @param field
         * @param rules
         * @param i
         ...
         * @returns
         */
        _maxCharNumber: function(field, rules, i, options) {
