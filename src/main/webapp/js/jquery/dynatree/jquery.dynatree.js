...
DynaTreeNode.prototype = {
	...
	_getInnerHtml: function() {
		...
		var inputbox =null ;
		if( opts.checkboxs ) {
			res += "<input type='checkbox' id='"+data.key+"' disabled='disabled'/>";
		}
		// Checkbox mode
...
//				this.tree.logDebug("nodeTitle: " + nodeTitle);
				...
				nodeTitle = '<a href="#" class="' + opts.classNames.title + '" onclick="'+ data.isClick +'"' + tooltip + '>' + data.title + '</a>';
			}
		}
		res += nodeTitle;
		return res;
...
//				this.span.innerHTML = this._getInnerHtml();
			...
			if( data.key && opts.generateIds ){
				this.span.id = opts.idPrefix + data.key;
			}
			// set node connector images, links and text
			this.span.innerHTML = this._getInnerHtml();
